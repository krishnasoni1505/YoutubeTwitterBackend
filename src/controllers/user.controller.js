...
const loginUser = asyncHandler( async (req,res) => {
    // get username/email + password from front end from req.body
    // use findone to get one from username/email
    // validate password using isPasswordCorrect method from user.model.js
    // give access token using method in userSchema
    // give refresh token using method in userSchema
    // send cookie
